...
from Network_Security.constants.training_pipeline import DATA_TRANSFORMTION_IMPUTER_PARAMS
...
class DataTransformation:
    ...
    def get_data_transformer_object(cls)->Pipeline:
        logging.info("Entered get_dat_transformer_object method of transformation class")
        try:
            imputer:KNNImputer = KNNImputer(**DATA_TRANSFORMTION_IMPUTER_PARAMS)
            logging.info(f"Initialize KNNimputer with {DATA_TRANSFORMTION_IMPUTER_PARAMS}")
