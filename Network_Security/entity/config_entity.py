...
class DataValidationConfig:
    def __init__(self,training_pipeline_config:TrainingPipelineConfig):
        ...
        self.invalied_train_file_path: str = os.path.join(training_pipeline_config.artifact_dir, training_pipeline.TRAIN_FILE_NAME)
        self.invalid_test_file_path: str = os.path.join(training_pipeline_config.artifact_dir, training_pipeline.TEST_FILE_NAME)
